...
And we can compare whether the results agree:

```{r compareihw12, fig.width = 3, fig.height = 3, out.width = "300px", warning = FALSE}
qplot(adj_pvalues(ihwF)[sim$reported], adj_pvalues(ihwS), cex = I(0.2), xlim = c(0, 0.1), ylim = c(0, 0.1))
```
