...
```{r plot_ihw_res, fig.width = 6, fig.height = 3.6}
plot(ihw_res)
```
...
As a further convenience for further work, a `r class(ihw_res)` object can be converted to a data.frame as follows:
