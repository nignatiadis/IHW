...
Similarly, IHW (Independent Hypothesis Weighting) is also a multiple testing procedure, but beyond the p-values, it also requires a covariate (filter statistic) which is independent of the p-values under the null hypothesis. Therefore the basic input of IHW is the following
